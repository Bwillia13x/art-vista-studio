            ...
            return (
              ...
              >
                <CardContent className="p-8">
                  <div className="mb-4">
                    <Icon className="w-8 h-8 text-primary/60 group-hover:text-primary transition-all duration-300 group-hover:scale-110" />
                  </div>
                  <h3 className="font-serif text-2xl text-primary mb-3 group-hover:text-primary/80 transition-colors">
                    {service.name}
                  </h3>
